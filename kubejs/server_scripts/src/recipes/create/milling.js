ServerEvents.recipes((event) => {
  let recipe_data_list = [
    ...
    {
      ingredients: [{ tag: "forge:dead_coral_block" }],
      result: "coralstfc:coral_powder",
      count: 4,
      id: "may:milling/coral_block",
    },
    {
      ingredients: [{ tag: "forge:dead_coral" }],
      result: "coralstfc:coral_powder",
      count: 2,
  ...
  global.colorsList.forEach((color) => {
    !/(dark_gray)|(black)|(cyan)/.exec(color) &&
      recipes.push({
        ingredients: [
          {
