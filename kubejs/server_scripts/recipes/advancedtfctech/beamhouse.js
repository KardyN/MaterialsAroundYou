ServerEvents.recipes((event) => {
  let recipes = [
    ...
    BeamhouseRecipeBuilder()
      ...
      .addInputFluid("minecraft:water", 4000)
      .addResult("kubejs:large_clean_hide", "add")
      .addTime(400)
      .addEnergy(8000)
      .build(),
    BeamhouseRecipeBuilder()
      ...
      .addInputFluid("minecraft:water", 2000)
      .addResult("kubejs:medium_clean_hide", "add")
      .addTime(300)
      .addEnergy(6000)
      .build(),
    BeamhouseRecipeBuilder()
      ...
      .addInputFluid("minecraft:water", 1000)
      .addResult("kubejs:small_clean_hide", "add")
      .addTime(200)
      .addEnergy(4000)
      .build(),
    ...
    BeamhouseRecipeBuilder()
      ...
      .addResult("tfc:large_soaked_hide", "copy")
      .addTime(400)
      .addEnergy(8000)
      .build(),
    BeamhouseRecipeBuilder()
      ...
      .addResult("tfc:medium_soaked_hide", "copy")
      .addTime(300)
      .addEnergy(6000)
      .build(),
    BeamhouseRecipeBuilder()
      ...
      .addResult("tfc:small_soaked_hide", "copy")
      .addTime(200)
      .addEnergy(4000)
      .build(),
    ...
    BeamhouseRecipeBuilder()
      ...
      .addResult("tfc:large_prepared_hide", "copy")
      .addTime(400)
      .addEnergy(8000)
      .build(),
    BeamhouseRecipeBuilder()
      ...
      .addResult("tfc:medium_prepared_hide", "copy")
      .addTime(300)
      .addEnergy(6000)
      .build(),
    BeamhouseRecipeBuilder()
      ...
      .addResult("tfc:small_prepared_hide", "copy")
      .addTime(200)
      .addEnergy(4000)
      .build(),
    ...
    BeamhouseRecipeBuilder()
      ...
      .addResult("kubejs:large_tanned_hide", "copy")
      .addTime(400)
      .addEnergy(8000)
      .build(),
    BeamhouseRecipeBuilder()
      ...
      .addResult("kubejs:medium_tanned_hide", "copy")
      .addTime(300)
      .addEnergy(6000)
      .build(),
    BeamhouseRecipeBuilder()
      ...
      .addResult("kubejs:small_tanned_hide", "copy")
      .addTime(200)
      .addEnergy(4000)
      .build(),
    ...
    BeamhouseRecipeBuilder()
      ...
      .addResult("kubejs:large_waterproof_hide", "copy")
      .addTime(400)
      .addEnergy(8000)
      .build(),
    BeamhouseRecipeBuilder()
      ...
      .addResult("kubejs:medium_waterproof_hide", "copy")
      .addTime(300)
      .addEnergy(6000)
      .build(),
    BeamhouseRecipeBuilder()
      ...
      .addResult("kubejs:small_waterproof_hide", "copy")
      .addTime(200)
      .addEnergy(4000)
      .build(),
...
function BeamhouseRecipeBuilder() {
  let recipe = {
    ...
    addResult: function (itemStack, bonus) {
      if (isNaN(itemStack[0])) {
        this._result = {
          stack: { id: itemStack },
          modifiers: [{ type: `advancedtfctech:${bonus}_machine_made` }],
        };
      } else {
        this._result = {
          stack: { id: itemStack.slice(3), count: parseInt(itemStack[0]) },
          modifiers: [{ type: "advancedtfctech:double_if_machine_made" }],
        };
      }
      return this;
    },
    ...
    addInputFluid: function (fluid, amount) {
      this._inputFluid = { fluid: fluid, amount: amount };
      return this;
    },
